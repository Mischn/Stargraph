 ...
 */
public abstract class BatchFileGenerator implements StreamRDF {
    private static final String DEFAULT_DATATYPE = "http://www.w3.org/1999/02/22-rdf-syntax-ns#langString";
    private static Logger logger = LoggerFactory.getLogger(BatchFileGenerator.class);
    ...
    public BatchFileGenerator(File directory, long maxEntriesInFile, String fileNamePrefix) {
    ...
    public void generateBatches(String uri) {
        RDFDataMgr.parse(this, uri);
    }
